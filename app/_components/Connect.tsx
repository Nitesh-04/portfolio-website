...
export default function Connect (){
    return (
        <div className="mt-20 md:px-10 pb-10">
            <p className={`text-gray-900 dark:text-white text-3xl font-bold px-10`}>Let&apos;s Connect</p>
            <div className="mt-10 px-10 ">
                <div className={`text-gray-900 dark:text-gray-300 ${chivo.className} md:w-4/5 text-justify`}>
                    ...
                    <div className="text-gray-900 dark:text-gray-300 mt-5 md:text-lg">
                        <p><EmailOutlined/> kakkar.nitesh04@gmail.com</p>
                        <p className="mt-2"><LocalPhoneOutlined/> +91 9599586696</p>
                    </div>
                    <div id="contact" className="flex gap-4 mt-5 text-gray-900 dark:text-white">
