    ...
    return (
        <div className="flex flex-col md:flex-row px-10 mt-5 md:py-2 md:mt-12 gap-4 md:gap-0">
            ...
            <div className="flex flex-col space-y-2 ">
                ...
                <p className={`text-gray-900 dark:text-white text-5xl md:text-6xl font-bold ${chivo.className}`}>Nitesh Kakkar.</p>
                <p className="text-gray-400 dark:text-gray-300 text-xl md:text-3xl font-bold">Student / Web Developer</p>
            </div>
            <div className="order-3 mt-6 md:mt-10">
                ...
                <p className="mt-10 text-lg"><a href="/Nitesh&apos;s Resume for website.pdf" className={`text-gray-900 dark:text-gray-300 font-lg underline mt-10 ${chivo.className}`} target="_blank" rel="noopener noreferrer" >Resume</a> <DownloadRoundedIcon className="text-gray-900 dark:text-white"/></p>
